...
import type { Schema, StructDef, Field } from './parser.js';
...
export function generateTypeScript(schema: Schema): string {
  ...
  lines.push('import { StructReader, StructBuilder, MessageReader, MessageBuilder, ElementSize } from \'@capnp-ts/core\';');
  lines.push('');
