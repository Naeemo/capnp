...
function generateReader(struct: Struct, dataWords: number, pointerCount: number, lines: string[]): void {
...
function generateBuilder(struct: Struct, dataWords: number, pointerCount: number, lines: string[]): void {
