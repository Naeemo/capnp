...
import { StructReader, StructBuilder } from '../../core/message-reader.js';
...
describe('Default Values - XOR Encoding', () => {
  ...
  describe('StructReader with defaults', () => {
    ...
    it('should read float64 with default value', () => {
      ...
      defaultView.setFloat64(0, 3.14159, true);
      actualView.setFloat64(0, 2.71828, true);
      ...
      expect(readValue).toBeCloseTo(2.71828, 5);
    });
  });
