...
describe('Basic Types - Floats', () => {
  it('should handle float32 special values', () => {
    ...
    root.setFloat32(0, 0);
    root.setFloat32(4, -0);
    root.setFloat32(8, Number.POSITIVE_INFINITY);
    root.setFloat32(12, Number.NEGATIVE_INFINITY);
    ...
    expect(reader.getFloat32(8)).toBe(Number.POSITIVE_INFINITY);
    expect(reader.getFloat32(12)).toBe(Number.NEGATIVE_INFINITY);
  });
...
describe('Basic Types - Mixed', () => {
  it('should handle mixed types in same struct', () => {
    ...
    expect(reader.getFloat64(8)).toBeCloseTo(Math.PI, 5);
