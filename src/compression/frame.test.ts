...
import { compressAndFrame, deframeAndDecompress } from './index';
import { compress, compressWithFallback, uncompress, uncompressWithFallback } from './lz4';
...
describe('Frame Format', () => {
  ...
  describe('compressFrame', () => {
    it('should frame compressed data', () => {
      ...
      const mockCompress = (_d: Uint8Array) => new Uint8Array([0x99]); // smaller
  ...
  describe('decompressFrame', () => {
    ...
    it('should decompress compressed frame', () => {
      ...
      const mockDecompress = (_d: Uint8Array, _size: number) => original;
...
describe('LZ4 Module', () => {
  describe('compress', () => {
    ...
    it('should compress data above threshold', () => {
      ...
      const _result = compress(data, { threshold: 1024 });
  ...
  describe('uncompress', () => {
    ...
    it('should return null for invalid data', () => {
      ...
      const _result = uncompress(invalid, 100);
