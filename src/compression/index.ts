...
import { FrameFlags, hasFrameMagic } from './frame.js';
...
// =============================================================================
import { type FrameResult, compressFrame, decompressFrame } from './frame.js';
import { type CompressionOptions, compress, uncompress } from './lz4.js';
 ...
 */
export function compressAndFrame(data: Uint8Array, options: CompressionOptions = {}): FrameResult {
 ...
 */
export function createCompressionConfig(config?: Partial<CompressionConfig>): CompressionConfig {
  return {
    enabled: false,
    algorithm: 'lz4',
    threshold: 1024,
